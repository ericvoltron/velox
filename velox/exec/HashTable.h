...
struct fmt::formatter<facebook::velox::exec::BaseHashTable::HashMode>
  ...
  auto format(facebook::velox::exec::BaseHashTable::HashMode s, format_context& ctx) {
    return formatter<std::string>::format(facebook::velox::exec::BaseHashTable::modeString(s), ctx);
  }
};
