...
struct fmt::formatter<facebook::velox::exec::SpillOperatorGroup::State>
  ...
  auto format(facebook::velox::exec::SpillOperatorGroup::State s, format_context& ctx) {
    return formatter<std::string>::format(facebook::velox::exec::SpillOperatorGroup::stateName(s), ctx);
  }
};
